...
print('Шаг 3:')
while True:
    key = input('Введите ваш ключ.\nКлюч должен быть не длиннее, чем 16 символов.\n')
...
# C:\Users\Voidless\PycharmProjects\Crypto\file.txt
# C:\Users\Voidless\PycharmProjects\Crypto\crypted_file.txt
